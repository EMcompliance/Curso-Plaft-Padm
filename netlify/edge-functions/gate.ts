...
<style>
  body{font-family:'Space Grotesk',Arial,Helvetica,sans-serif;background:#EFEDE4;color:#0B1F33;margin:0;padding:24px;min-height:100vh;box-sizing:border-box;}
  ...
  .brand-row .badge{width:32px;height:32px;border-radius:7px;display:flex;align-items:center;justify-content:center;font-family:'Space Mono',monospace;font-weight:700;font-size:11px;color:#fff;flex-shrink:0;}
  .brand-row .name{font-size:13px;font-weight:600;color:#0B1F33;}
  .eyebrow{font-family:'Space Mono',monospace;font-size:10.5px;font-weight:700;letter-spacing:1.3px;text-transform:uppercase;color:${accent};margin-bottom:8px;}
  ...
  .footnote-row{display:flex;align-items:center;gap:6px;font-size:10.5px;color:#5C6B7A;font-family:'Space Mono',monospace;letter-spacing:.3px;}
  ...
  .thumb{width:34px;height:34px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-family:'Space Mono',monospace;font-weight:700;font-size:11px;color:#fff;flex-shrink:0;object-fit:cover;}
  .client-row-main .info{flex:1;min-width:120px;}
  .client-row-main .info .dname{font-size:13.5px;font-weight:600;}
  .client-row-main .info .slug{font-family:'Space Mono',monospace;font-size:11px;color:#8a97a3;}
