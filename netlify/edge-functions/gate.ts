...
<style>
  ...
  .pw-wrap input{margin-bottom:0;padding-right:64px;}
  .pw-toggle{position:absolute;top:0;right:0;height:100%;width:auto;padding:0 12px;background:none;border:none;color:#5C6B7A;font-size:11.5px;font-weight:600;cursor:pointer;font-family:inherit;}
  .pw-toggle:hover{color:${accent};}
...
<form method="POST" action="${esc(opts.action)}">
  ...
  <div class="pw-wrap">
    ...
    <button type="button" class="pw-toggle" id="loginPwBtn" onclick="togglePw()">Ver</button>
  </div>
